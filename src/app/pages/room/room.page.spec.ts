...
describe('RoomComponent', () => {
  ...
  it('ngOnInit: should set socket connection', () => {
    const spyOnInit = jest.spyOn(component, 'ngOnInit'); // Espía el método ngOnInit
    spyOnInit.mockImplementationOnce(() => {});
  ...
  //   mockPlayers[0].selected_card!.value = 5;
  //   mockPlayers[1].selected_card!.value = -1;
  //   mockPlayers[2].selected_card!.value = 13;
  //   mockPlayers[3].selected_card!.value = -2;
  ...
  //   mockPlayers[1].selected_card!.value = -2;
  //   mockPlayers[3].selected_card!.value = 23;
  //   component.players = mockPlayers;
  //   const res = component.allPlayersSelectedCard();
